...
export default function AgentLoginPage() {
  ...
  const handleGoogleSignIn = () => {
    // For agents, we'll check if they're an agent after Google auth
      ...
      <div className="min-h-screen bg-whatsapp-gray-light flex items-center justify-center p-4">
        <div className="bg-white rounded-lg shadow-xl p-8 w-full max-w-md">
          ...
          <button
            ...
            disabled={loading}
            className="w-full mb-4 px-4 py-3 bg-white border-2 border-gray-300 rounded-md hover:bg-gray-50 transition-colors flex items-center justify-center gap-3 disabled:opacity-50"
          >
